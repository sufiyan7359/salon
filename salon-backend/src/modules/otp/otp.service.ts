...
export class OtpService {
  ...
  async requestOtp(
    ...
    this.deliverOtp(phoneNumber, otpCode);
  ...
  private deliverOtp(phoneNumber: string, otpCode: string): void {
    // Stubbed SMS provider: logs instead of sending until Twilio/MSG91 is wired up.
